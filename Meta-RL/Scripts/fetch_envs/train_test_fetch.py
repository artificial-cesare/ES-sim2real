...
from stable_baselines3 import PPO, LSTM

from stable_baselines3.common.utils import set_random_seed

#from stable_baselines3.common.callbacks import CheckpointCallback

def train_model(env_name, seed, train_steps, policy_kwargs, n_envs, n_steps, batch_size, n_epochs, gamma, ent_coef, gae_lambda, config, use_sde, sde_sample_freq=4):
    """
    ...
    env = make_vec_env(gym.make(env_name, max_episode_steps=100), n_envs=n_envs, seed=seed, vec_env_cls=SubprocVecEnv)
...
def test_model(model_path, env_path, env_name, seed, n_envs, config, n_eval_episodes=50):
    ...
    env = make_vec_env(env_name, n_envs, seed=seed, vec_env_cls=SubprocVecEnv)
