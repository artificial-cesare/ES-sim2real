...
class Fr3Robot(MujocoEnv):
    ...
    def __init__(
        self,
        model_path=r"C:\Users\cesar\OneDrive\Desktop\Meta-RL\Scripts\Panda\Gymnasium-Robotics-main\gymnasium_robotics\envs\assets\fr3\fr3_hand.xml",
        frame_skip=40,
